      ...
      <div class="space-y-4">
        ...
        <FormField v-slot="{ field: componentField }" name="username">
          <FormItem>
            ...
            <FormMessage />
            <FormDescription> 用户名用于登录系统，3-50个字符 </FormDescription>
          </FormItem>
        </FormField>
        ...
        <FormField v-slot="{ field: componentField }" name="email">
          <FormItem>
            ...
            <FormMessage />
            <FormDescription> 用于接收系统通知和密码重置 </FormDescription>
          </FormItem>
        </FormField>
        ...
        <FormField v-if="!isEditMode" v-slot="{ field: componentField }" name="password">
          <FormItem>
            ...
            <FormMessage />
            <FormDescription> 密码至少需要6位字符 </FormDescription>
          </FormItem>
        </FormField>
      </div>
      ...
      <div class="space-y-4">
        ...
        <FormField v-slot="{ field: componentField }" name="role">
          <FormItem>
            ...
            <FormDescription> 管理员：基本管理权限；超级管理员：完整系统权限 </FormDescription>
            <FormMessage />
          </FormItem>
        </FormField>
        ...
        <FormField v-if="isEditMode" v-slot="{ field: componentField }" name="status">
          <FormItem>
            ...
            <FormDescription> 禁用后用户将无法登录系统 </FormDescription>
            <FormMessage />
          </FormItem>
        </FormField>
      </div>
