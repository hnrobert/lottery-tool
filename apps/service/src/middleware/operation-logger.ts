...
type GetTargetInfo = (
  ...
  res: Response,
  data: any,
) => { type: string | null; id: string | number | null } | null
    ...
    (req: Request, _res: Response, data: any) => {
      const activityName =
        ...
        (data &&
          ...
          JSON.parse(data).data.activity &&
          JSON.parse(data).data.activity.name) ||
        '未知活动'
    ...
    (req: Request, _res: Response, data: any) => {
      const activityId =
        ...
        (data &&
          JSON.parse(data).data &&
          JSON.parse(data).data.activity &&
          JSON.parse(data).data.activity.id)
      return {
        type: 'ACTIVITY',
        id: activityId,
      }
  ...
  return logOperation(
    ...
    (req: Request, _res: Response, data: any) => {
      const prizeName =
        ...
        (data &&
          JSON.parse(data).data &&
          JSON.parse(data).data.prize &&
          JSON.parse(data).data.prize.name) ||
        '未知奖品'
  ...
  return logOperation(
    ...
    (_req: Request, _res: Response, data: any) => {
      try {
        ...
        const prizeName =
          responseData.data && responseData.data.prize && responseData.data.prize.name
  ...
  return logOperation(
    ...
    (req: Request, _res: Response, data: any) => {
      const username =
        ...
        (data &&
          JSON.parse(data).data &&
          JSON.parse(data).data.user &&
          JSON.parse(data).data.user.username) ||
        '未知用户'
